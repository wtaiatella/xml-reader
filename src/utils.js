			...
			for (let child of worldmap.children) {
				...
				if (name == 'GoView') {
					...
					if (childName == 'btnUnifilarGeral') {
						...
						const newBtnValue = `
							AXD/KF8DAAdHUkZFRE9NCgAAAAD//v8AAP/+/wAFT0NYUEECAAAAAAAFT0NY
							Q0laAQAABAAAAAABAAAEAAAA8NeSEQAAAQAAACR5ek2NhdQRvzoAYAhbeYIA
							...
							AAB7AEUARQBEADUAQgBFAEYANAAtADMARQBBAEUALQA0ADgAQgBFAC0AOAA5
							ADcAOAAtADEAMAA3ADQAOAAxADEAMwA2AEYAQgA2AH0AAAAIAAIAAAAAAAgA
