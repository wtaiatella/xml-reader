			...
			for (let child of worldmap.children) {
				...
				if (name == 'GoView') {
					...
					if (childName == 'btnUnifilarGeral') {
						...
						const newBtnValue = `
							AS8yzoIDAAdHUkZFRE9NCgAAAAD//v8AAP/+/wAFT0NYUEECAAAAAAAFT0NY
							Q0lcAQAABAAAAAABAAAEAAAAqEHVGgAAAQAAACR5ek2NhdQRvzoAYAhbeYIA
							...
							TgAAAHsARAAzADIAQwA4AEYAMABCAC0AMwBBAEYAOQAtADQARABFADAALQBB
							ADgAQQA3AC0AOQAwAEIAMABFADgANwA2AEUANAA4AEUAfQAAAAgAAgAAAAAA
